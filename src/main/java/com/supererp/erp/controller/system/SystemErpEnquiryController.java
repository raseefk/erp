...
@Controller
@RequestMapping("/system/enquiries")
...
public class SystemErpEnquiryController {
    ...
    public String list(@RequestParam(defaultValue = "0") int page,
        ...
        if (status != null && !status.isBlank()) {
            try {
                st = EnquiryStatus.valueOf(status.toUpperCase());
    ...
    public String updateStatus(@PathVariable Long id,
        ...
        try {
            ...
            ra.addFlashAttribute("errorMessage", "Error updating status: " + e.getMessage());
        }
        return "redirect:/system/enquiries/" + id;
    }
