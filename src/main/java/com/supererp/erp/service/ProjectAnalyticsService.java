...
import com.supererp.erp.entity.DailyLog;
import com.supererp.erp.repository.DailyLogRepository;
import com.supererp.erp.repository.ProjectExpenseRepository;
...
public class ProjectAnalyticsService {
    ...
    public ProjectPulse getProjectPulse(Long projectId, BigDecimal contractValue) {
        ...
        BigDecimal totalExp   = expRepo.sumByProjectAndStatus(projectId,
            com.supererp.erp.enums.ProjectExpenseStatus.APPROVED);
