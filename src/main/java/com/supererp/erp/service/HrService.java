...
import com.supererp.erp.repository.AttendanceRepository;
import com.supererp.erp.repository.EmployeeRepository;
import com.supererp.erp.repository.LeaveApplicationRepository;
import com.supererp.erp.repository.LeaveBalanceRepository;
...
public class HrService {
    ...
    private final com.supererp.erp.repository.HolidayRepository holidayRepository;
    ...
    public org.springframework.data.domain.Page<com.supererp.erp.dto.AttendanceReportDto> getAttendanceReportPaginated(Integer year, Integer month, Long employeeId, int page, int size) {
        List<com.supererp.erp.dto.AttendanceReportDto> all = getAttendanceReport(year, month, employeeId);
    ...
    public List<com.supererp.erp.dto.AttendanceReportDto> getAttendanceReport(Integer year, Integer month, Long employeeId) {
        ...
        for (Employee emp : targetEmployees) {
            ...
            for (LocalDate d = start; !d.isAfter(end); d = d.plusDays(1)) {
                ...
                report.add(com.supererp.erp.dto.AttendanceReportDto.builder()
                        .date(current)
                        .employee(emp)
        ...
        report.sort(java.util.Comparator.comparing(com.supererp.erp.dto.AttendanceReportDto::getDate)
    ...
    public java.util.List<com.supererp.erp.dto.CalendarDayDto> getAttendanceCalendar(Long employeeId, int year, int month) {
        java.time.YearMonth ym = java.time.YearMonth.of(year, month);
        LocalDate start = ym.atDay(1);
        LocalDate end = ym.atEndOfMonth();
        ...
        java.util.List<com.supererp.erp.dto.CalendarDayDto> calendar = new java.util.ArrayList<>();
        ...
        for (LocalDate d = start; !d.isAfter(end); d = d.plusDays(1)) {
            ...
            calendar.add(com.supererp.erp.dto.CalendarDayDto.builder()
                .date(current)
                .attendance(att)
                .approvedLeave(leave)
                .isLeave(leave != null)
