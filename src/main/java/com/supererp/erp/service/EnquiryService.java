...
import com.supererp.erp.repository.EnquiryRepository;
...
public class EnquiryService {
    ...
    public Page<com.supererp.erp.projection.EnquirySummary> getAll(int page, int size, String q, EnquiryStatus status) {
