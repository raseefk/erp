...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    org.springframework.data.domain.Page<com.supererp.erp.projection.EmployeeSummary> searchSummary(@org.springframework.data.repository.query.Param("q") String q, org.springframework.data.domain.Pageable p);
