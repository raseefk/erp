...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    Page<com.supererp.erp.projection.CustomerSummary> findAllSummaries(Pageable p);
    ...
    Page<com.supererp.erp.projection.CustomerSummary> searchSummaries(@Param("q") String q, Pageable p);
}
