...
import com.supererp.erp.entity.Enquiry;
...
public interface EnquiryRepository extends JpaRepository<Enquiry, Long> {
    ...
    Page<com.supererp.erp.projection.EnquirySummary> findAllSummaries(Pageable p);
    ...
    Page<com.supererp.erp.projection.EnquirySummary> searchSummaries(@Param("q") String q, @Param("status") EnquiryStatus status, Pageable p);
}
